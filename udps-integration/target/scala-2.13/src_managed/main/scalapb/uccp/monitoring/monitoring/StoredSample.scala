...
final case class StoredSample(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[StoredSample] {
    @transient
    ...
    def withValue(__v: _root_.scala.Double): StoredSample = copy(value = __v)
    ...
    def clearTimestamp: StoredSample = copy(timestamp = _root_.scala.None)
    def withTimestamp(__v: com.google.protobuf.timestamp.Timestamp): StoredSample = copy(timestamp = Option(__v))
    ...
    def companion: uccp.monitoring.monitoring.StoredSample.type = uccp.monitoring.monitoring.StoredSample
    // @@protoc_insertion_point(GeneratedMessage[uccp.monitoring.StoredSample])
}

object StoredSample extends scalapb.GeneratedMessageCompanion[uccp.monitoring.monitoring.StoredSample] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[uccp.monitoring.monitoring.StoredSample] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): uccp.monitoring.monitoring.StoredSample = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[uccp.monitoring.monitoring.StoredSample] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = MonitoringProto.javaDescriptor.getMessageTypes().get(1)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = MonitoringProto.scalaDescriptor.messages(1)
  ...
  lazy val defaultInstance = uccp.monitoring.monitoring.StoredSample(
    value = 0.0,
    timestamp = _root_.scala.None
  )
  implicit class StoredSampleLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, uccp.monitoring.monitoring.StoredSample]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, uccp.monitoring.monitoring.StoredSample](_l) {
  ...
  ): _root_.uccp.monitoring.monitoring.StoredSample = _root_.uccp.monitoring.monitoring.StoredSample(
    value,
    timestamp
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[uccp.monitoring.StoredSample])
}
