...
final case class Response(
    ...
    def withSuccess(__v: _root_.scala.Boolean): Response = copy(success = __v)
    def withMessage(__v: _root_.scala.Predef.String): Response = copy(message = __v)
    def withErrorCode(__v: _root_.scala.Predef.String): Response = copy(errorCode = __v)
    def withCorrelationId(__v: _root_.scala.Predef.String): Response = copy(correlationId = __v)
    ...
    def clearTimestamp: Response = copy(timestamp = _root_.scala.None)
    def withTimestamp(__v: com.google.protobuf.timestamp.Timestamp): Response = copy(timestamp = Option(__v))
    ...
    def companion: uccp.common.common.Response.type = uccp.common.common.Response
    // @@protoc_insertion_point(GeneratedMessage[uccp.common.Response])
}

object Response extends scalapb.GeneratedMessageCompanion[uccp.common.common.Response] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[uccp.common.common.Response] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): uccp.common.common.Response = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[uccp.common.common.Response] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = uccp.common.common.Response(
    success = false,
    message = "",
    errorCode = "",
    correlationId = "",
  ...
  implicit class ResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, uccp.common.common.Response]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, uccp.common.common.Response](_l) {
  ...
  ): _root_.uccp.common.common.Response = _root_.uccp.common.common.Response(
    success,
    message,
    errorCode,
    correlationId,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[uccp.common.Response])
}
