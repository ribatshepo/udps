...
final case class Timestamp(
    ...
    def companion: udps.api.common.Timestamp.type = udps.api.common.Timestamp
    // @@protoc_insertion_point(GeneratedMessage[udps.api.Timestamp])
}

object Timestamp extends scalapb.GeneratedMessageCompanion[udps.api.common.Timestamp] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[udps.api.common.Timestamp] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): udps.api.common.Timestamp = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[udps.api.common.Timestamp] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = udps.api.common.Timestamp(
    seconds = 0L,
    nanos = 0
  )
  implicit class TimestampLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, udps.api.common.Timestamp]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, udps.api.common.Timestamp](_l) {
  ...
  ): _root_.udps.api.common.Timestamp = _root_.udps.api.common.Timestamp(
    seconds,
    nanos
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[udps.api.Timestamp])
}
